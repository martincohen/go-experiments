...
var TopicWhere = struct {
	...
	CreatedBy: whereHelperstring{field: "\"topics\".\"created_by\""},
	Title:     whereHelperstring{field: "\"topics\".\"title\""},
}
...
func (r *topicR) GetCreatedByUser() *User {
	if r == nil {
		return nil
	}
...
func (r *topicR) GetComments() CommentSlice {
	if r == nil {
		return nil
	}
	return r.Comments
...
var (
	topicAllColumns            = []string{"id", "created_at", "created_by", "title"}
	topicColumnsWithoutDefault = []string{"id", "created_by", "title"}
...
func (o *Topic) CreatedByUser(mods ...qm.QueryMod) userQuery {
...
func (o *Topic) Comments(mods ...qm.QueryMod) commentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"comments\".\"topic_id\"=?", o.ID),
	)
...
func (topicL) LoadCreatedByUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTopic interface{}, mods queries.Applicator) error {
	var slice []*Topic
	var object *Topic
	...
	if singular {
		...
		foreign.R.CreatedByTopics = append(foreign.R.CreatedByTopics, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.CreatedBy == foreign.ID {
				...
				foreign.R.CreatedByTopics = append(foreign.R.CreatedByTopics, local)
				break
			}
		}
	}
...
func (topicL) LoadComments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTopic interface{}, mods queries.Applicator) error {
	var slice []*Topic
	var object *Topic
	...
	query := NewQuery(
		qm.From(`comments`),
		qm.WhereIn(`comments.topic_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetCreatedByUser of the topic to the related item.
// Sets o.R.CreatedByUser to related.
// Adds o to related.R.CreatedByTopics.
func (o *Topic) SetCreatedByUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &userR{
			CreatedByTopics: TopicSlice{o},
		}
	} else {
		related.R.CreatedByTopics = append(related.R.CreatedByTopics, o)
	}
...
func (o *Topic) AddComments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Comment) error {
	var err error
