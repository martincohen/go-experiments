...
var CommentTableColumns = struct {
	...
	CreatedBy: "comments.created_by",
	TopicID:   "comments.topic_id",
	Body:      "comments.body",
}
...
var CommentWhere = struct {
	...
	CreatedBy: whereHelperstring{field: "\"comments\".\"created_by\""},
	TopicID:   whereHelperstring{field: "\"comments\".\"topic_id\""},
...
func (r *commentR) GetCreatedByUser() *User {
	if r == nil {
		return nil
	}
...
func (r *commentR) GetTopic() *Topic {
	if r == nil {
		return nil
	}
	return r.Topic
...
var (
	commentAllColumns            = []string{"id", "created_at", "created_by", "topic_id", "body"}
	commentColumnsWithoutDefault = []string{"id", "created_by", "topic_id", "body"}
...
func (o *Comment) CreatedByUser(mods ...qm.QueryMod) userQuery {
...
func (o *Comment) Topic(mods ...qm.QueryMod) topicQuery {
	queryMods := []qm.QueryMod{
...
func (commentL) LoadCreatedByUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeComment interface{}, mods queries.Applicator) error {
	var slice []*Comment
	var object *Comment
	...
	if singular {
		...
		foreign.R.CreatedByComments = append(foreign.R.CreatedByComments, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.CreatedBy == foreign.ID {
				...
				foreign.R.CreatedByComments = append(foreign.R.CreatedByComments, local)
				break
			}
		}
	}
...
// loaded structs of the objects. This is for an N-1 relationship.
func (commentL) LoadTopic(ctx context.Context, e boil.ContextExecutor, singular bool, maybeComment interface{}, mods queries.Applicator) error {
	var slice []*Comment
	var object *Comment
...
// SetCreatedByUser of the comment to the related item.
// Sets o.R.CreatedByUser to related.
// Adds o to related.R.CreatedByComments.
func (o *Comment) SetCreatedByUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &userR{
			CreatedByComments: CommentSlice{o},
		}
	} else {
		related.R.CreatedByComments = append(related.R.CreatedByComments, o)
	}

	return nil
}

// SetTopic of the comment to the related item.
// Sets o.R.Topic to related.
// Adds o to related.R.Comments.
func (o *Comment) SetTopic(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Topic) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
