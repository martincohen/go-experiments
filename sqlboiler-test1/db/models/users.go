...
var UserRels = struct {
	CreatedByComments string
	CreatedByTopics   string
}{
	CreatedByComments: "CreatedByComments",
	CreatedByTopics:   "CreatedByTopics",
}

// userR is where relationships are stored.
type userR struct {
	CreatedByComments CommentSlice `boil:"CreatedByComments" json:"CreatedByComments" toml:"CreatedByComments" yaml:"CreatedByComments"`
	CreatedByTopics   TopicSlice   `boil:"CreatedByTopics" json:"CreatedByTopics" toml:"CreatedByTopics" yaml:"CreatedByTopics"`
}
...
func (r *userR) GetCreatedByComments() CommentSlice {
	if r == nil {
		return nil
	}
	return r.CreatedByComments
}

func (r *userR) GetCreatedByTopics() TopicSlice {
	if r == nil {
		return nil
	}
	return r.CreatedByTopics
}
...
var (
	userAllColumns            = []string{"id", "created_at", "is_active", "name", "secret"}
	userColumnsWithoutDefault = []string{"id", "is_active", "name", "secret"}
...
// CreatedByComments retrieves all the comment's Comments with an executor via created_by column.
func (o *User) CreatedByComments(mods ...qm.QueryMod) commentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"comments\".\"created_by\"=?", o.ID),
	)

	return Comments(queryMods...)
}

// CreatedByTopics retrieves all the topic's Topics with an executor via created_by column.
func (o *User) CreatedByTopics(mods ...qm.QueryMod) topicQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"topics\".\"created_by\"=?", o.ID),
	)

	return Topics(queryMods...)
}

// LoadCreatedByComments allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadCreatedByComments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`comments`),
		qm.WhereIn(`comments.created_by in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.CreatedByComments = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.CreatedBy {
				local.R.CreatedByComments = append(local.R.CreatedByComments, foreign)
				if foreign.R == nil {
					foreign.R = &commentR{}
				}
...
// LoadCreatedByTopics allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadCreatedByTopics(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`topics`),
		qm.WhereIn(`topics.created_by in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.CreatedByTopics = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &topicR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.CreatedBy {
				local.R.CreatedByTopics = append(local.R.CreatedByTopics, foreign)
				if foreign.R == nil {
					foreign.R = &topicR{}
				}
				foreign.R.CreatedByUser = local
...
// AddCreatedByComments adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.CreatedByComments.
// Sets related.R.CreatedByUser appropriately.
func (o *User) AddCreatedByComments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Comment) error {
	var err error
	...
	if o.R == nil {
		o.R = &userR{
			CreatedByComments: related,
		}
	} else {
		o.R.CreatedByComments = append(o.R.CreatedByComments, related...)
	}
...
// AddCreatedByTopics adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.CreatedByTopics.
// Sets related.R.CreatedByUser appropriately.
func (o *User) AddCreatedByTopics(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Topic) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.CreatedBy = o.ID
	...
	if o.R == nil {
		o.R = &userR{
			CreatedByTopics: related,
		}
	} else {
		o.R.CreatedByTopics = append(o.R.CreatedByTopics, related...)
	}
